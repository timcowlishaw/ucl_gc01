...
// This program will be called DrawArc and must be
// to stored in a file called DrawArc.java.
//
// To create your own program with a different name,
// change *all* the occurrences of DrawArc to the new
...
// OVER A YEAR AGO!
public class DrawArc extends Frame
{
  ...
  public static void main(String[] args)
  {
     ...
     // "My DrawArc". Change the text to change
     // the label.
     DrawArc frame = new DrawArc("My DrawArc") ;
